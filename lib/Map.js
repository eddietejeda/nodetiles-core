...
Map.prototype = {
  ...
  render: function(options) {
    ...
    this._getData(bounds.minX, bounds.minY, bounds.maxX, bounds.maxY, req, function(error, shapes) {
      if (error) {
  ...
  _getData: function(minX, minY, maxX, maxY, request, callback) {
    ...
    async.map(
      ...
      function(datasource, dataCallback) {
        ...
        var syncData = datasource(minX - buffer, minY - buffer, maxX + buffer, maxY + buffer, projection, request, preCallback);
        if (syncData) {
